...
class PositionSizer:
    ...
    def fixed_fractional(self, available_capital: float, entry_price: float, stop_loss: float) -> float:
    ...
    def apply_symbol_cap(self, quantity: float, entry_price: float, total_capital: float) -> float:
        ...
        if position_value > max_value:
            ...
            logger.warning("position_capped_by_symbol_limit", original=quantity, capped=round(capped, 6))
