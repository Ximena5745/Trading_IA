...
async def trader_ai_exception_handler(request: Request, exc: TraderAIError) -> JSONResponse:
...
class ErrorHandler:
    ...
    def log_and_raise(
        ...
        log_instance.error("raising_exception", error_class=error_class.__name__, message=message, **(context or {}))
