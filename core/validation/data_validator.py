...
class EnhancedDataValidator:
    ...
    def validate_portfolio_health(self, portfolio_data: Dict[str, Any]) -> ValidationResult:
    ...
    def _validate_price_consistency(self, data: Dict[str, Any]) -> List[ValidationError]:
