#!/usr/bin/env python3
"""
Clasifica y mueve TODOS los archivos {symbol}_{tf}.{parquet,csv} de la raíz de data/raw a la carpeta y periodicidad correcta.
No lista, solo mueve. Ignora los que ya están bien ubicados.
"""
