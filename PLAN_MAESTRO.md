...
| 3 | `dashboard.py` God File (931 líneas en plan de mayo) | ⚪ no re-verificado en esta pasada; god files pendientes: `i1_gate_validator.py` (730L), `asset_specific_models.py` (745L). `mtf_sl_tp_manager.py` (810L) 🟢 **refactorizado 2026-07-27** — ver fila de arriba | 8h + refactor de los 2 restantes |
